...
<title>best_practices – quantdev.blog</title>
<style>
...
<link href="../../../../../../site_libs/quarto-html/quarto-syntax-highlighting-15634bcf2e68342d4ad2dfa704d543f6.css" rel="stylesheet" class="quarto-color-scheme" id="quarto-text-highlighting-styles">
<link href="../../../../../../site_libs/quarto-html/quarto-syntax-highlighting-dark-0a6b7249c26820e032cb0bd839ff02b1.css" rel="stylesheet" class="quarto-color-scheme quarto-color-alternate" id="quarto-text-highlighting-styles">
...
<link href="../../../../../../site_libs/bootstrap/bootstrap-1d5b463106a723d99fbfec1b44490ec9.min.css" rel="stylesheet" append-hash="true" class="quarto-color-scheme" id="quarto-bootstrap" data-mode="light">
<link href="../../../../../../site_libs/bootstrap/bootstrap-dark-b1f1ede0d46e86a7c532ca3621a6190a.min.css" rel="stylesheet" append-hash="true" class="quarto-color-scheme quarto-color-alternate" id="quarto-bootstrap" data-mode="dark">
<link href="../../../../../../site_libs/bootstrap/bootstrap-1d5b463106a723d99fbfec1b44490ec9.min.css" rel="stylesheet" append-hash="true" class="quarto-color-scheme-extra" id="quarto-bootstrap" data-mode="light">
...
<style>
  ...
  @import url('https://fonts.googleapis.com/css2?family=Quicksand:wght@400;500;700&family=Source+Serif+4:ital,opsz,wght@0,8..60,400;0,8..60,600;1,8..60,400;1,8..60,600&family=JetBrains+Mono:wght@400;500&display=swap');
...
<div id="quarto-search-results"></div>
  <header id="quarto-header" class="headroom fixed-top">
    ...
    <img src="../../../../../.././symbol.svg" alt="" class="navbar-logo light-content">
    <img src="../../../../../.././symbol.svg" alt="" class="navbar-logo dark-content">
    </a>
...
<span class="menu-text">Newsletter</span></a>
  ...
  <li class="nav-item">
    <a class="nav-link" href="../../../../../../sell_side_quant_critical_path.html"> 
  ...
  window.document.addEventListener("DOMContentLoaded", function (event) {
    ...
    if (window.document.getElementById('quarto-embedded-source-code-modal')) {
      ...
      var mailtoRegex = new RegExp(/^mailto:/);
        var filterRegex = new RegExp("http:\/\/quantdev\.blog");
      var isInternal = (href) => {
...
<script>
  function loadGiscus() {
    ...
    script.async = true;
    script.dataset.repo = "quasar-chunawala/quantdev";
    script.dataset.repoId = "R_kgDOL2t5-A";
    script.dataset.category = "General";
    script.dataset.categoryId = "DIC_kwDOL2t5-M4ClndQ";
