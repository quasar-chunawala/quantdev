...
- [Introducing C++: The Easy Way to Start Learning Modern C++](https://www.amazon.co.uk/Introducing-Easy-Start-Learning-Modern/dp/1098178149) by Frances Buontempo, programmer since the 90s, BA, Msc in pure math and learnt to program by reading the manual for her Dad's BBC model B machine.
...
- [Eric Rigtorp's blog](https://rigtorp.se/)
- [Lock-free programming resources](https://github.com/rigtorp/awesome-lockfree )

#### Functional programming.
- [Functional programming in C++](https://a.co/d/01QQyziL) by Ivan Cukic.

## Computer Architecture
- [Inside the Machine](https://amzn.eu/d/hus6b9R) by Jon Stokes.

## Operating Systems

- [Earth and Grass OS](https://egos.fun/book/overview.html) - The goal is to build an undergraduate-level OS in C under 2k lines of code, that runs on QEMU. The basic scaffolding is already provided and you need to fill in the bits. Most OS concepts stick when you implement something yourself.

## Cheatsheets
- [STL Algorithms](https://hackingcpp.com/cpp/cheat_sheets.html) by Andre Muller.
...
- [CppCon videos](https://www.youtube.com/cppcon) - My suggestion is to cultivate a daily habit to watch two CppCon videos each day.
- [h/cpp](https://hackingcpp.com/cpp/educational_videos) - Educational C++ videos categorized and tagged.

## Blog-rolls worth reading

- [GlobalCpp landing page](https://globalcpp.github.io/)  - A collaboration between numerous regional C++ user groups.
- [https://wrocpp.github.io/](https://wrocpp.github.io/), the Wroclaw C++ community page.
- [Barry Revzin's blog](https://brevzin.github.io/)
- [Louis Dionne's blog](https://ldionne.com/), the author of `boost::hana`
- [Andrzej Krzemieński's blog](https://thecppway.com/)
