...
```
[Compiler Explorer](https://compiler-explorer.com/z/Gv65nrhrs)

## Understanding the constrained algorithms

The standard library provides over a hundred general-purpose algorithms. Most of these algorithms have a new constrained version in
`std::ranges` namespace. These algorithms are found in the `<algorithm>`, `<numeric>` and `<memory>` header.
...
From [cppreference.com](https://en.cppreference.com/w/cpp/algorithm/ranges/copy.html), the rangified version of the `copy_if` algorithm has the following overloads:
...
```
[Compiler Explorer](https://compiler-explorer.com/z/v4hTef7Wb)
...
- *[A beginner’s guide to C++ Ranges and Views](https://
hannes.hauswedell.net/post/2019/11/30/range_intro/), Hannes Hauswedell*
- *[C++ Code Samples Before and After Ranges](https://
mariusbancila.ro/blog/2019/01/20/cpp-code-samples-before-
and-after-ranges/), Marius Bancila*