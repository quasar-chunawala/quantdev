...
**Type requirements** are introduced with the `typename` keyword followed by the name of a type. The type must be valid for the requirement to be true. Let's code up an example:
