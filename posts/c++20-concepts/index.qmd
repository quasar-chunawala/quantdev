...
Note, that `std::void_t<B1,B2,...,BN>` is a utility type metafunction that maps a sequence of any types to `void`. It is a convenient way to leverage SFINAE prior to C++20's concepts. 