...
$$
\begin{align*}
\sigma(X_s) &= \sigma(X_{t_j}) + \int_{t_j}^{t_{j+1}}\sigma'(X_u) dX_U + \frac{1}{2}\int_{t_j}^{t_{j+1}} \sigma''(X_u)(dX_u)^2\\
\mu(X_s) &= \mu(X_{t_j}) + \int_{t_j}^{t_{j+1}}\mu'(X_u) dX_U + \frac{1}{2}\int_{t_j}^{t_{j+1}} \mu''(X_u)(dX_u)^2
\end{align*}
