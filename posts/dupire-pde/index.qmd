...
Breeden & Litzenberger in 1978, showed that this second-order partial derivative can be used to approximate the option-implied risk-neutral probability that the underlying asset price $S$ will be equal to the strike $K$ at maturity.

## Dupire PDE in terms of implied volatility
