...
We then define $u_n$ to be the probability that a given walk is at the origin on the $n$th step, defining the value $u_0=1$ for the trivial loop. 
...
### Recurrence and transience of a brownianian motion in $\mathbf{R}^d$
