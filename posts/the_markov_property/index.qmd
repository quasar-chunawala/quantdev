...
Thus, the function $f$ can be represented as:
...
The transition probability density function (heat kernel) $p(x,t|y,0)$ is given by:
...
&=\frac{1}{\sqrt{2\pi}} \cdot \frac{(x-y)^2 - t}{t^{5/2}}
\end{align*}
