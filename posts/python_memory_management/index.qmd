...
Pools are $4$KB subdivisions (or $16$ Kb on large systems) of arenas. Each pool manages blocks of single size class and can be in three states:
...
Each `arena_object` node contains a pointer (`freepools`) to the linked list of pools. 
