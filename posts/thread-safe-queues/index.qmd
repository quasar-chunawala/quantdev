...
namespace dev {
    ...
    public:
        threadsafe_ring_buffer() {}
        threadsafe_ring_buffer(const threadsafe_ring_buffer& other)
        {
            std::lock_guard<std::mutex> lck(mtx);
            m_ring_buffer = other.m_ring_buffer;
        }
        threadsafe_ring_buffer& operator=(const threadsafe_ring_buffer& other) = delete;
        ...
        void wait_and_pop(T& value) {
            std::unique_lock<std::mutex> lck(mtx);
            queue_not_empty_cond.wait([this]() { return !m_ring_buffer.empty();});
