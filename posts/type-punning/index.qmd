...
This algorithm computes the inverse square root $1/\sqrt{x}$ and it appears in the source code for *Quake-3*, written by the legendary game programmer [John Carmack](https://en.wikipedia.org/wiki/John_Carmack). This code works roughly $4$ times faster than the naive `1.0/sqrt(x)`, and the maximum relative error over all floating point numbers is $0.175228$ percent. How does it work? What bit master designed such an incredible hack?
...
Floating-point numbers are stored in the following format:
