...
> [[intro.abstract]](https://eel.is/c++draft/intro.abstract#6.sentence-5)/6 If the execution of operation results in erroneous behavior, the implementation is permitted to issue a diagnostic and terminate the execution of the program. 
