...
From the theorem on linear independence of orthogonal vectors, $\{\mathbf{q}_{1},\ldots,\mathbf{q}_{n}\}$ are linearly independent and hence form an orthonormal basis for $\mathbf{R}^{n}$.