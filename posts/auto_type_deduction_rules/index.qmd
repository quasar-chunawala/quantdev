...
You can have a constant pointer-to-`int`, in which case the expression is a constant. Or you can have a pointer-to-`const`, in which case you have a expression containing `const`.
