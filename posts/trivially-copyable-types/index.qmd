...
Another implication of the way, `std::is_trivially_copyable_v<T>` is currently imeplemented, is that you can have a type that is not trivially copy constructible / copy assignable and yet it is trivially copyable.
