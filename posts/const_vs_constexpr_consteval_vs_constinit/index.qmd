...
`if consteval` checks if the current function execution is being done at run-time or compile-time, allowing you to pick between a run-time specialized or compile-time specialized version of the same function. 
