...
```
[Compiler Explorer](https://compiler-explorer.com/z/G7cM7dqzd)

The three types `Line`, `Circle` and `Rectangle` don't have any special relationship. In fact, they do not have a common base class, no virtual functions and their interfaces might even diffe