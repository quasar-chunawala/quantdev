...
`integral_constant` is just a class, it has no data. Its just a wrapper over a compile-time constant of a specified type. I think the name `integral_constant` 