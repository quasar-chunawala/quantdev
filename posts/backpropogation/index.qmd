...
## Adding `backward()` to `DenseLayer` and Activation functions
...
class DenseLayer:
    ...
    def backward(self, dloss_dz):
        ...
        self.dloss_dweights = np.outer(self.dloss_dz, self.dz_dweights)
        self.dloss_dbiases = self.dloss_dz
...
class ReLUActivation:
    ...
    def backward(self, dloss_da):
        ...
        self.da_dz = np.where(self.inputs > 0., 1., 0.)
