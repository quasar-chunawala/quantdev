...
## Joint distribution between $\sup B_t$ and the endpoint $B_T$

The same reasoning gives us the joint distribution between the running maximum of the brownian motion and the endpoint for free.

\begin{align*}
\mathbb{P}\left(\sup_{t\leq T} B_t > m, B_T \leq a\right)
\end{align*}