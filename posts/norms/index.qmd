...
### Deriving the constants for bounds $\norm{\bf{x}}_1 \leq C_{1,\infty}\norm{\bf{x}}_\infty$ and $\norm{\bf{x}}_\infty \leq C_{\infty,1}\norm{\bf{x}}_1$
...
Similarly, we can derive the constant $C_{2,1}$ and $C_{1,2}$. We have:
