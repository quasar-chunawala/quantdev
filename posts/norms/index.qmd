...
$$
\begin{align*}
\max_{\norm{\bf{x}}_2 = \norm{\bf{y}}_2 = 1} |\bf{y}^H A \bf{x}| &\geq \max_{\norm{\bf{x}}_2 = 1} |(\frac{A\bf{x}}{\norm{A\bf{x}}_2})^H A \bf{x}| & \{\text{ Specific vector }\}\\
&= \max_{\norm{\bf{x}}_2 = 1} \frac{\norm{A\bf{x}}_2^2}{\norm{A\bf{x}}_2}\\
&=\max_{\norm{\bf{x}}_2 = 1} \norm{A\bf{x}}_2\\
&= \norm{A}_2
\end{align*}
