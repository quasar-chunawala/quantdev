...
I've got my hands on the [C++ lambda story](https://leanpub.com/cpplambda) by [Bartłomiej Filipek](https://leanpub.com/u/fenbf) and wanted to try out a few of the examples. 
...
```
[Compiler Explorer](https://compiler-explorer.com/z/TY98T8nxM)
...
```
[Compiler Explorer](https://compiler-explorer.com/z/z34cTcabh)
...
```
[Compiler Explorer](https://compiler-explorer.com/z/rdEsPK8va)
...
```
[Compiler Explorer](https://compiler-explorer.com/z/7hh15dbbo)
...
```
[Compiler Explorer](https://compiler-explorer.com/z/81hM5cGbr)
...
```
[Compiler Explorer](https://compiler-explorer.com/z/5sf3We9zY)
