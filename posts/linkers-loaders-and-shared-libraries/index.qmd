...
This stub starts with an indirect jump to the `got` slot. As we mentioned, initially, this slot contains the address of somewhere that performs the resolution. And this somewhere is exactly the next instruction in the stub. 