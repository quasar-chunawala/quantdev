...
Let's discuss another mechanism that supports interposition. The default behavior is governed by the default switch `--allow-shlib-undefined`. If we have the below tree of dependencies
