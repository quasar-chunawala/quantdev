...
In Windows, the usual singleton design pattern would create a per-binary singleton. You would need to export the singleton variable from a shared library and and you need to have all the binaries in the process link against that single shared library that implements this singleton and consume it from there.

In Linux, you just need to code your singleton and put it in the executable. 

# C++ Implication #2 : Can you have circular library dependencies?

Can we have circular binary dependencies? That is to say, 