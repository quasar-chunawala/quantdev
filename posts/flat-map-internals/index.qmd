...
```{.cpp include="./hashtable_control_bytes.h" start-line=123 end-line=162 code-line-numbers="true" filename="absl/container/internal/hashtable_control_bytes.h"}
```

`T` controls the number of bits in the bitset. 
