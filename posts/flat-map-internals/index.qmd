...
# Trade-offs between node-based and flat (probing) hash-tables

The Boost documentation gives a nice summary of some of the tradeoffs between node-based and flat associative containers.
