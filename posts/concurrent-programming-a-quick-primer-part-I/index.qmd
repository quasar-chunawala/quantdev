...
1. By moving the thread `t2`, `t1` gets a new work package and its destructor is called. As a result, `t1`'s destructor calls `std::terminate`, because it is still joinable.
