...
\end{minipage}};
% Text Node
\draw (227,128) node [anchor=north west][inner sep=0.75pt]  [xscale=2,yscale=2] [align=left] {\textit{L1 Cache}};
% Text Node
\draw (519.5,127.5) node [anchor=north west][inner sep=0.75pt]  [xscale=2,yscale=2] [align=left] {\textit{L1 Cache}};
% Text Node
\draw (463.33,302.67) node [anchor=north west][inner sep=0.75pt]  [xscale=2,yscale=2] [align=left] {\textit{Main Memory}};
% Text Node
\draw (298.33,344.17) node [anchor=north west][inner sep=0.75pt]  [xscale=2,yscale=2] [align=left] {\textit{64-bytes}};
% Text Node
\draw (198.83,312.17) node [anchor=north west][inner sep=0.75pt]  [xscale=2,yscale=2] [align=left] {\textit{Cache line}};
% Text Node
...
\end{minipage}};
% Text Node
\draw (227.67,189.33) node [anchor=north west][inner sep=0.75pt]  [xscale=2,yscale=2] [align=left] {\textit{L2 Cache}};
% Text Node
\draw (522.83,189.5) node [anchor=north west][inner sep=0.75pt]  [xscale=2,yscale=2] [align=left] {\textit{L2 Cache}};
% Text Node
...
\end{minipage}};
% Text Node
\draw (512.33,246.67) node [anchor=north west][inner sep=0.75pt]  [xscale=2,yscale=2] [align=left] {\textit{L3 Cache}};
