...
% Text Node
\draw (52,42) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textit{CPU Core-1}};
% Text Node
\draw (342,40) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textit{CPU Core-2}};
% Text Node
...
\draw (113.63,136.75) node   [align=left] {\begin{minipage}[lt]{72.93pt}\setlength\topsep{0pt}
x[0],x[1],...
\end{minipage}};
% Text Node
\draw (227,128) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textit{L1 Cache}};
% Text Node
\draw (519.5,127.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textit{L1 Cache}};
% Text Node
\draw (463.33,302.67) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textit{Main Memory}};
% Text Node
\draw (298.33,344.17) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textit{64-bytes}};
% Text Node
\draw (198.83,312.17) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textit{Cache line}};
% Text Node
\draw (179.83,68.63) node   [align=left] {\begin{minipage}[lt]{48.73pt}\setlength\topsep{0pt}
++x[0];
\end{minipage}};
% Text Node
\draw (467.67,68.13) node   [align=left] {\begin{minipage}[lt]{41.71pt}\setlength\topsep{0pt}
++x[1];
\end{minipage}};
% Text Node
...
\draw (405.13,136.25) node   [align=left] {\begin{minipage}[lt]{72.93pt}\setlength\topsep{0pt}
x[0],x[1],...
\end{minipage}};
% Text Node
...
\draw (334.13,318.42) node   [align=left] {\begin{minipage}[lt]{72.93pt}\setlength\topsep{0pt}
x[0],x[1],...
\end{minipage}};
% Text Node
...
\draw (114.29,198.08) node   [align=left] {\begin{minipage}[lt]{72.93pt}\setlength\topsep{0pt}
x[0],x[1],...
\end{minipage}};
% Text Node
\draw (227.67,189.33) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textit{L2 Cache}};
% Text Node
\draw (522.83,189.5) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textit{L2 Cache}};
% Text Node
...
\draw (405.79,197.58) node   [align=left] {\begin{minipage}[lt]{72.93pt}\setlength\topsep{0pt}
x[0],x[1],...
\end{minipage}};
% Text Node
...
\draw (331.63,254.08) node   [align=left] {\begin{minipage}[lt]{72.93pt}\setlength\topsep{0pt}
x[0],x[1],...
\end{minipage}};
% Text Node
\draw (512.33,246.67) node [anchor=north west][inner sep=0.75pt]   [align=left] {\textit{L3 Cache}};
