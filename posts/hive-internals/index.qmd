...
The memory space of the first erased element in each skipblock is `reinterpret_cast`d via pointers as two index numbers, the first giving the index of the previous skipblock in that memory block, the second giving the index of the next skipblock in the sequence.
