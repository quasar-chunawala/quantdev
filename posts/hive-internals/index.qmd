...
**Node**. A single integer within the skip field array. For a boolean skipfield array, this is always either `0` or `1`. For an LCJC skipfield, 

# References

- [Colonies, performance and why should we care](https://www.youtube.com/watch?v=wBER1R8YyGY), *CppCon 20216, Matt Bentley*.
